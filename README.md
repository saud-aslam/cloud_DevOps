...
The deployment of this application to cloud was done on Amazon Web Services (AWS). But before that we used Docker to manually deploy our application 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwNTAxNzk4MCwxODI3MDEzODExLC0xNj
