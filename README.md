...
This problem is solved by using Elastic Beanstalk (EB). By using this service of AWS, one can fully rely on EB
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0NDUyMTkyMiw5NzE3NzEyNTEsMTg4Mj
